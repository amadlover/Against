...
AGAINST_RESULT scene_spawn_skinned_actor (const char* name)
{
    ...
    {
        scene_obj->skinned_actors = (skinned_actor*) utils_calloc (1, sizeof (actor_get_skinned_actor_size ()));
    }
    else
    {
        scene_obj->skinned_actors = (skinned_actor*) utils_realloc_zero (scene_obj->skinned_actors, sizeof (actor_get_skinned_actor_size ()) * scene_obj->num_skinned_actors, sizeof (actor_get_skinned_actor_size ()) * (scene_obj->num_skinned_actors + 1));
    }
